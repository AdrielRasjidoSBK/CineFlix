...
while(true){
    ...
    case 13: //ENTER
        ...
        case 1:
            recuadro(47,29,19,2);
            gotoxy(49,30); cout << "Capital Federal";
        break;
        case 2:
            recuadro(47,29,19,2);
            gotoxy(49,30); cout << "Zona Norte     ";
        break;
        case 3:
            recuadro(47,29,19,2);
            gotoxy(49,30); cout << "Zona Oeste     ";
        break;
        case 4:
            recuadro(47,29,19,2);
            gotoxy(49,30); cout << "Zona Sur       ";
        break;
        }
        opc = getch();
    }
...
void sala::cargar(bool _modificacion){
    ...
    ShowConsoleCursor(true);
    gotoxy(49,30);
    strcpy(localidad, ElejirLocalidad());
    if(_modificacion == false){
    ShowConsoleCursor(false);
    int opc, pos=1;
    while(true){
